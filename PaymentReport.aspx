<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="PaymentReport.aspx.cs" Inherits="PaymentReport" Title="Untitled Page" %>
    ...
    <tr>
        ...
        <td colspan="2">
            <asp:GridView ID="gv1" runat="server" AllowPaging="True" 
                ...
                OnPageIndexChanging="gv1_PageIndexChanging" PageSize="8" 
                Width="100%">
                <Columns>
            ...
            <br />
            <asp:Label ID="lblToal" runat="server"></asp:Label>
        </td>
        <td style="WIDTH: 5%">
            </td>
    </tr>
