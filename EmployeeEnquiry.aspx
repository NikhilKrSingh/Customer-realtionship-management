<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="EmployeeEnquiry.aspx.cs" Inherits="EmployeeEnquiry" Title="Untitled Page" %>
            ...
            <tr>
                ...
                <td style="width: 289px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtname"
                        ErrorMessage="Name is required!" ValidationGroup="a" Width="213px"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td style="width: 167px">
                    Address</td>
